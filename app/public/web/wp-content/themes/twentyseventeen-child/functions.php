...
function theme_enqueue_scripts() {
  ...
  wp_enqueue_script( 'child-slick-script-masonry', get_stylesheet_directory_uri() . '/assets/js/jquery.masonry.min.js' );
  wp_enqueue_script( 'child-slick-script-infinitescroll', get_stylesheet_directory_uri() . '/assets/js/jquery.infinitescroll.min.js' );
